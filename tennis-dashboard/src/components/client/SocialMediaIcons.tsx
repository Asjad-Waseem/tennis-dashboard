  ...
  return (
    <div
      ...
      style={{
        ...
        height: "20px",
        left: "27px",
        top: "232px", // 452px - 220px (adjusted for new purple section height, relative to white section)
      }}
    >
      {/* Twitter Icon */}
      <a
        href="#"
        className="flex-none transition-all duration-200 hover:scale-110"
        style={{
          width: "20px",
          height: "20px",
        }}
      ...
      >
        <svg
          ...
          style={{ fill: colors.primary.blueLight, transition: "fill 0.2s ease" }}
        >
