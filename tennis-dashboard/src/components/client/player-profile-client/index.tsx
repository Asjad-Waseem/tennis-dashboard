...
const PlayerProfileClient = (): React.ReactElement => {
  ...
  return (
    <aside
      className="relative h-[400px] sm:h-[450px] md:h-[480px] lg:h-[505px] w-full lg:w-[400px] overflow-visible rounded-2xl sm:rounded-3xl drop-shadow-[0px_50px_80px_rgba(102,30,255,0.2)]"
    >
      {/* Main Card Container */}
      <div className="absolute inset-0 overflow-visible rounded-3xl bg-white">
        {/* Top Purple Gradient Section */}
        <div
          className="absolute top-0 left-0 right-0 h-[180px] sm:h-[200px] md:h-[210px] lg:h-[220px] overflow-visible rounded-t-2xl sm:rounded-t-3xl bg-gradient-to-br from-[#5C24FC] to-[#9D7AFF]"
        >
        ...
        <div className="absolute left-0 right-0 top-[180px] sm:top-[200px] md:top-[210px] lg:top-[220px] h-[220px] sm:h-[250px] md:h-[270px] lg:h-[285px] overflow-visible rounded-b-2xl sm:rounded-b-3xl bg-white">
          ...
          <div className="absolute left-4 sm:left-5 lg:left-6 top-5 sm:top-6 lg:top-7 h-[50px] w-[42px] sm:h-[55px] sm:w-[46px] lg:h-[60px] lg:w-[50px] overflow-hidden rounded-[16px_8px] sm:rounded-[18px_9px] lg:rounded-[20px_10px]">
            <div className="absolute inset-0 rounded-[16px_8px] sm:rounded-[18px_9px] lg:rounded-[20px_10px] bg-[#FFC2F9]" />
            <div className="absolute inset-0 rounded-[16px_8px] sm:rounded-[18px_9px] lg:rounded-[20px_10px] opacity-30 bg-[#C4C4C4]" />
            {/* Player Avatar Image */}
            <div className="absolute left-[3.5px] sm:left-1 lg:left-[4.5px] top-[1.4px] sm:top-[1.5px] lg:top-[1.69px] h-[47px] w-[35px] sm:h-[51px] sm:w-[38px] lg:h-[56.62px] lg:w-[41px] overflow-hidden bg-[#FFC2F9]">
              <Image
                src={player.avatar}
